...
The armor set features are added again. [Cobblemon Armors Feature](https://modrinth.com/mod/cobblemon-armors-feature) mod is no longer required. `enableCobblemonArmorsFeature` game rule is added.

## Game Rules

### `enableCobblemonArmorsFeature`
