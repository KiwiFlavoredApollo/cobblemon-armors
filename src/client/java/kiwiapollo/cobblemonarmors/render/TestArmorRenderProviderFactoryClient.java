...
public class TestArmorRenderProviderFactoryClient implements RenderProviderFactory {
    @Override
        ...
        return new RenderProvider() {
            ...
            public BipedEntityModel<LivingEntity> getHumanoidArmorModel(
                ...
                GeoArmorRenderer<MythrilArmorItem> renderer = new GeoArmorRenderer<>(
                        new DefaultedItemGeoModel<>(Identifier.of(CobblemonArmors.NAMESPACE, "test_armor"))
                );
