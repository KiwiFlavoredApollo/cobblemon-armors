...
public class WhiteTeamPlasmaArmorRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.WHITE_TEAM_PLASMA_HELMET.getItem())
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.WHITE_TEAM_PLASMA_CHESTPLATE.getItem())
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.WHITE_TEAM_PLASMA_LEGGINGS.getItem())
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.WHITE_TEAM_PLASMA_BOOTS.getItem())
