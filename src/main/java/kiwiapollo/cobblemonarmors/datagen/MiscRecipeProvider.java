...
public class MiscRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.PIKACHU_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.MAGIKARP_HELMET)
                .input(Items.LEATHER_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.SLOWKING_HELMET)
                .input(Items.LEATHER_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.DAWN_HELMET)
                .input(Items.LEATHER_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.LYRA_HELMET)
                .input(Items.LEATHER_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.FENNEKIN_HELMET)
                .input(Items.LEATHER_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.FENNEKIN_CHESTPLATE)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.BUTTERFREE_HELMET)
                .input(Items.LEATHER_HELMET)
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.COMBAT, ModArmorItem.BUTTERFREE_CHESTPLATE)
                .input(Items.LEATHER_CHESTPLATE)
                .input(ItemTags.SMALL_FLOWERS)
