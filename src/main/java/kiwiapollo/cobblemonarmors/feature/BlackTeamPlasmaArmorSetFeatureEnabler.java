...
public class BlackTeamPlasmaArmorSetFeatureEnabler extends ArmorSetFeatureEnabler {
    private static final Map<EquipmentSlot, Item> ARMOR_SET = Map.ofEntries(
            Map.entry(EquipmentSlot.HEAD, ModArmorItem.BLACK_TEAM_PLASMA_HELMET),
            Map.entry(EquipmentSlot.CHEST, ModArmorItem.BLACK_TEAM_PLASMA_CHESTPLATE),
            Map.entry(EquipmentSlot.LEGS, ModArmorItem.BLACK_TEAM_PLASMA_LEGGINGS),
            Map.entry(EquipmentSlot.FEET, ModArmorItem.BLACK_TEAM_PLASMA_BOOTS)
    );
