...
public class WhiteTeamPlasmaArmorSetFeatureEnabler extends ArmorSetFeatureEnabler {
    private static final Map<EquipmentSlot, Item> ARMOR_SET = Map.ofEntries(
            Map.entry(EquipmentSlot.HEAD, ModArmorItem.WHITE_TEAM_PLASMA_HELMET),
            Map.entry(EquipmentSlot.CHEST, ModArmorItem.WHITE_TEAM_PLASMA_CHESTPLATE),
            Map.entry(EquipmentSlot.LEGS, ModArmorItem.WHITE_TEAM_PLASMA_LEGGINGS),
            Map.entry(EquipmentSlot.FEET, ModArmorItem.WHITE_TEAM_PLASMA_BOOTS)
    );
