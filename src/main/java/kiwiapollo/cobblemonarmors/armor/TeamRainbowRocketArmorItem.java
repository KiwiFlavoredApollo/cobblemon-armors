...
public class TeamRainbowRocketArmorItem {
    ...
    public static final Item TEAM_RAINBOW_ROCKET_HELMET = register("team_rainbow_rocket_helmet", new Helmet());
    public static final Item TEAM_RAINBOW_ROCKET_CHESTPLATE = register("team_rainbow_rocket_chestplate", new Chestplate());
    public static final Item TEAM_RAINBOW_ROCKET_LEGGINGS = register("team_rainbow_rocket_leggings", new Leggings());
    public static final Item TEAM_RAINBOW_ROCKET_BOOTS = register("team_rainbow_rocket_boots", new Boots());
